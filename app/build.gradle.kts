...
android {
    namespace = "com.budgetwise.financial"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.budgetwise.financial"
        minSdk = 21
        targetSdk = 34
        versionCode = 2
        versionName = "2.0"
    ...
    /*signingConfigs {
        getByName("debug") {
            storeFile = file("ID528.keystore")
            keyAlias = "mypass"
            storePassword = "com.budgetwise.financial"
            keyPassword = "com.budgetwise.financial"
        }
        create("release") {
            keyAlias = "mypass"
            keyPassword = "com.budgetwise.financial"
            storeFile = file("ID527.keystore")
            storePassword = "com.budgetwise.financial"
